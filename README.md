...
Der [Ciclop 3D-Scanner](https://github.com/LibreScanner/ciclop) stellt einen sehr kostengünstigen Einstieg in die 3D Scan Techanik dar. Sie können sich anhand der [deutschen Einführung](http://diwo.bq.com/de/einfuhrung-ciclop-und-horus/) oder [englischen Einführung](http://diwo.bq.com/en/presentation-ciclop-horus/) rasch einen Überblick über das BQ Ciclop Projekt verschaffen. Besonders hervorheben möchten wir, dass sowohl der [theoretische Hintergrund des Scanners](https://github.com/Jesus89/3DScanScience) als auch die Software [Horus](http://horus.readthedocs.io/en/release-0.2/) zur Steuerung des Scanners hervorragend dokumentiert sind. Die Software hat außerdem die nötige Flexibilität für eigene Weiterentwicklungen mit akzeptablem Aufwand.
